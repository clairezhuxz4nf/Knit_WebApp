    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          ...
          <h2 className="font-display text-sm font-semibold text-foreground truncate mx-3">{item.title}</h2>
          <button
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="relative aspect-[4/3] bg-muted">
            ...
            <div className="absolute bottom-2 right-2 bg-background/80 backdrop-blur-sm rounded-full p-2 cursor-pointer hover:bg-background/90 transition-colors">
          ...
          <div className="flex items-center gap-2 px-5 pt-4 pb-2">
            <img src={item.avatarUrl} alt={item.personName} className="w-7 h-7 rounded-full object-cover border border-border" />
