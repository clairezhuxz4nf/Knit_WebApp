...
export const YarnDecoration = ({
    ...
    return (
      ...
      >
        <path
          ...
          className={cn(colorMap[color], "fill-none")}
          strokeWidth="3"
          strokeLinecap="round"
        />
      </svg>
  ...
  if (variant === "spiral") {
    return (
      ...
      >
        <path
          d="M25 5 Q35 15 25 25 Q15 35 25 45"
          className={cn(colorMap[color], "fill-none")}
          strokeWidth="3"
          strokeLinecap="round"
        />
    ...
    return (
      ...
      >
        <circle
          ...
          cy="20"
          r="15"
          className={cn(fillColorMap[color], "opacity-30")}
        />
        <circle
          cx="20"
          cy="20"
        ...
        />
        <path
          d="M10 15 Q20 10 30 15 M10 20 Q20 15 30 20 M10 25 Q20 20 30 25"
          className={cn(colorMap[color], "fill-none opacity-60")}
          strokeWidth="1.5"
        />
      </svg>
    );
  ...
  return (
    ...
    >
      <path
        d="M16 28 C6 20 2 14 6 8 C10 2 16 6 16 10 C16 6 22 2 26 8 C30 14 26 20 16 28Z"
        className={cn(fillColorMap[color], "opacity-80")}
      />
    </svg>
  );
};
